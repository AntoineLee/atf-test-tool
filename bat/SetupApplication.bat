...
:: Android packaging
set AND_CERT_NAME="ATF_showcase_app"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\ATFshowcaseapp.p12
...
set IOS_PROVISION=cert\ATFshowcaseapp.mobileprovision
...
set APP_ID=air.ATFshowcaseapp

:: Output packages
set DIST_PATH=dist
set DIST_NAME=ATFshowcaseapp

:: Debugging using a custom IP
set DEBUG_IP=192.168.1.12
